...
public final class IDirect3DDevice extends IUnknown {
	...
	public static int method15865(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int method15866(long l, int i, boolean bool) {
	...
	public static int method15867(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int method15868(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int method15869(long l, int i, boolean bool) {
		return SetRenderStateb(l, i, bool);
	}

	public static int method15870(long l, int i, boolean bool) {
		return SetRenderStateb(l, i, bool);
	}

	public static int method15871(long l, int i, boolean bool) {
		return SetRenderStateb(l, i, bool);
	}

	public static int method15872(long l, int i, boolean bool) {
		return SetRenderStateb(l, i, bool);
	}
}
