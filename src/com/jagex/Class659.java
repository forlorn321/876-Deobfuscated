...
public class Class659 {
	...
	public static void method7967() {
		...
		if (-1621465757 * client.anInt11036 > 0) {
			...
			for (int i = 0; i < client.anInt11036 * -1621465757; i++) {
				...
				class536_sub23.aClass536_Sub33_Sub2_10528.writeByte(interface63.method413(-31039471), 465637339);
		...
		if (client.aBool11242 && -518444133 * anInt8500 <= 0) {
			...
			class536_sub23.aClass536_Sub33_Sub2_10528.method9737(i_0_, -1952316498);
			class536_sub23.aClass536_Sub33_Sub2_10528.method9736(i, -1411037171);
		...
		if (!client.aBool11015) {
			...
			class536_sub23.aClass536_Sub33_Sub2_10528.method9696(class536_sub33.buffer, 0, class536_sub33.off * -810172525, (byte) 53);
	...
	public static void method7968() {
		...
		if (-1621465757 * client.anInt11036 > 0) {
			...
			for (int i = 0; i < client.anInt11036 * -1621465757; i++) {
				...
				if (l > 16777215L)
					l = 16777215L;
				aLong8501 = interface63.method415((byte) 0) * 8021461918566662789L;
				class536_sub23.aClass536_Sub33_Sub2_10528.writeByte(interface63.method413(-14240644), 465637339);
		...
		if (client.aBool11242 && -518444133 * anInt8500 <= 0) {
			...
			class536_sub23.aClass536_Sub33_Sub2_10528.method9737(i_5_, -1952316498);
			class536_sub23.aClass536_Sub33_Sub2_10528.method9736(i, -1411037171);
		...
		if (!client.aBool11015) {
			...
			int i = (-810172525 * class536_sub23.aClass536_Sub33_Sub2_10528.off);
			RSByteBuffer class536_sub33 = Class710.aClass536_Sub40_8843.method9852(-534711081);
			class536_sub23.aClass536_Sub33_Sub2_10528.method9696(class536_sub33.buffer, 0, class536_sub33.off * -810172525, (byte) 91);
