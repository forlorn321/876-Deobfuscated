...
public class Class56 implements ConfigType {
	int[] anIntArray603;
	public int anInt604;
	public int anInt605;
	...
	static final void method964(IComponentDefinitions[] class251s, int i, int i_16_) {
		for (int i_17_ = 0; i_17_ < class251s.length; i_17_++) {
			IComponentDefinitions class251 = class251s[i_17_];
			if (null != class251) {
