...
public class Class492 {
	...
	boolean method5893(byte[] is, Interface58 interface58, int i, float f, boolean bool, boolean bool_0_, int i_1_, float f_2_, Object object, int i_3_) {
		synchronized (this) {
			...
			if (null != is_4_) {
				...
				anInt5493 = class536_sub33.readInt() * 752681551;
				anInt5520 = class536_sub33.readInt() * -729674031;
				anInt5494 = class536_sub33.readInt() * 1103211933;
				...
				for (int i_7_ = 0; i_7_ < 1165836469 * anInt5494; i_7_++) {
					...
					anIntArray5498[i_7_] = class536_sub33.readInt();
					anIntArray5497[i_7_] = class536_sub33.readInt();
	...
	static final void method5972(IComponentDefinitions class251, Class234 class234, Class668 class668, byte i) {
