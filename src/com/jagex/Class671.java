...
public class Class671 {
	...
	static void method8018(IComponentDefinitions class251, Class244 class244, int i, int i_6_, int i_7_, int i_8_, int i_9_, long l) {
	...
	public static Class234 method8019(int i, int[] is, Class234 class234, boolean bool, byte i_30_) {
		...
		if (i_31_ == 0)
			class251s = new IComponentDefinitions[0];
