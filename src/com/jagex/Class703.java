...
public final class Class703 {
	...
	static final void method8259(Class668 class668, int i) {
		...
		OutgoingPacketContainer class536_sub23 = Class213.createOutgoingPacket(OutgoingPacket.aClass414_4415, class106.aClass15_1258, 1684418284);
		class536_sub23.stream.writeByte(0);
		int i_9_ = (class536_sub23.stream.off * -810172525);
		class536_sub23.stream.writeString(string);
		class536_sub23.stream.writeShort(810974573 * class668.aClass382_8551.anInt4013, -1778059594);
		...
		class536_sub23.stream.method9699((class536_sub23.stream.off * -810172525 - i_9_), -300297454);
		class106.writePacket(class536_sub23, 346931047);
	}
}
