	...
	static int method4168() {
		...
		if (Class483.aClass303_5431 == Class303.aClass303_3421 && Class644.aClass628_8352.anInt8195 * 1657790451 != -1) {
			...
			for (int i = 0; i < (Class463.aClass234Array5227[1657790451 * Class644.aClass628_8352.anInt8195].aClass251Array2378).length; i++) {
				Class251 class251 = (Class463.aClass234Array5227[1657790451 * Class644.aClass628_8352.anInt8195].aClass251Array2378[i]);
				if (1049444347 * class251.anInt2728 == 5 && -1 != class251.anInt2592 * -1307221069 && !Class398.aClass461_4122.method5558((-1307221069 * (class251.anInt2592)), 0, 758234553))
					bool = false;
			}
			if (!bool)
				return 0;
