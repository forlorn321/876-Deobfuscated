		...
		try {
			...
			for (int i_2_ = 0; i_2_ < 100; i_2_++) {
				...
				if (aClass536_Sub18_Sub15_Sub2_5202 == null) {
					...
					if (i_4_ > i_3_)
						i_4_ = i_3_;
					aClass567_10290.copyBuffer((inStream.buffer), (inStream.off * -810172525), i_4_, -1540123216);
					if (aByte5182 != 0) {
					...
					if (class536_sub33 == null) {
						...
						if (buffer.off * -810172525 >= 5) {
							...
							class536_sub33.writeByte(i_12_);
							class536_sub33.writeInt(i_13_);
							anInt5201 += -1828991779;
						}
					} else {
		...
		try {
			...
			for (int i = 0; i < 100; i++) {
				...
				if (aClass536_Sub18_Sub15_Sub2_5202 == null) {
					...
					if (i_19_ > i_18_)
						i_19_ = i_18_;
					aClass567_10290.copyBuffer((inStream.buffer), (inStream.off * -810172525), i_19_, 1273047684);
					if (aByte5182 != 0) {
					...
					if (class536_sub33 == null) {
						...
						if (buffer.off * -810172525 >= 5) {
							...
							class536_sub33.writeByte(i_27_);
							class536_sub33.writeInt(i_28_);
							anInt5201 += -1828991779;
						}
					} else {
		...
		try {
			...
			for (int i = 0; i < 100; i++) {
				...
				if (aClass536_Sub18_Sub15_Sub2_5202 == null) {
					...
					if (i_34_ > i_33_)
						i_34_ = i_33_;
					aClass567_10290.copyBuffer((inStream.buffer), (inStream.off * -810172525), i_34_, 341199586);
					if (aByte5182 != 0) {
					...
					if (class536_sub33 == null) {
						...
						if (buffer.off * -810172525 >= 5) {
							...
							class536_sub33.writeByte(i_42_);
							class536_sub33.writeInt(i_43_);
							anInt5201 += -1828991779;
						}
					} else {
