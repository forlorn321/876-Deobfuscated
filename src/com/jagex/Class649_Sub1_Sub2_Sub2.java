...
public class Class649_Sub1_Sub2_Sub2 extends Class649_Sub1_Sub2 implements Interface59 {
	boolean aBool11996;
	MeshRasterizer aClass177_11997;
	...
	MeshRasterizer method10941(GraphicalRenderer class167, int i, byte i_0_) {
	...
	Class7 method10942(GraphicalRenderer class167, int i, boolean bool, int i_1_) {
	...
	boolean method9969(GraphicalRenderer class167, int i, int i_3_) {
		...
		MeshRasterizer class177 = method10941(class167, 131072, (byte) 32);
		if (class177 != null) {
			Class433 class433 = method7851();
	...
	public Class649_Sub1_Sub2_Sub2(Class553 class553, GraphicalRenderer class167, Class34_Sub17 class34_sub17, ObjTypeDecoder class612, int i, int i_4_, int i_5_, int i_6_, int i_7_, boolean bool, int i_8_, boolean bool_9_) {
		...
		if (class7 != null) {
			aClass177_11997 = (MeshRasterizer) class7.anObject117;
	...
	MeshRasterizer method10943(GraphicalRenderer class167, int i) {
		if (aClass177_11997 != null && class167.method2308(aClass177_11997.method2466(), i) == 0)
			return aClass177_11997;
	...
	boolean method9939(GraphicalRenderer class167, int i, int i_11_, byte i_12_) {
		...
		MeshRasterizer class177 = method10941(class167, 131072, (byte) -40);
		if (class177 != null) {
			Class433 class433 = method7851();
	...
	void method9943(GraphicalRenderer class167, Class649_Sub1 class649_sub1, int i, int i_13_, int i_14_, boolean bool, int i_15_) {
	...
	boolean method9957(GraphicalRenderer class167, int i, int i_17_) {
		...
		MeshRasterizer class177 = method10941(class167, 131072, (byte) 18);
		if (class177 != null) {
			Class433 class433 = method7851();
	...
	boolean method9971(GraphicalRenderer class167, int i, int i_18_) {
		...
		MeshRasterizer class177 = method10941(class167, 131072, (byte) 23);
		if (class177 != null) {
			Class433 class433 = method7851();
	...
	void method9947(GraphicalRenderer class167, Class649_Sub1 class649_sub1, int i, int i_19_, int i_20_, boolean bool) {
		if (class649_sub1 instanceof Class649_Sub1_Sub2_Sub2) {
	...
	void method9978(GraphicalRenderer class167, Class649_Sub1 class649_sub1, int i, int i_22_, int i_23_, boolean bool) {
		if (class649_sub1 instanceof Class649_Sub1_Sub2_Sub2) {
	...
	MeshRasterizer method10944(GraphicalRenderer class167, int i) {
		if (aClass177_11997 != null && class167.method2308(aClass177_11997.method2466(), i) == 0)
			return aClass177_11997;
	...
	Class7 method10945(GraphicalRenderer class167, int i, boolean bool) {
