	...
	void method7414(RSByteBuffer class536_sub33, int i) {
		for (;;) {
			...
			if (0 == i_0_)
				break;
			if (1 == i_0_)
				anInt8118 = class536_sub33.readInt() * -576652699;
			else if (2 == i_0_)
				anInt8119 = class536_sub33.readInt() * -266523553;
			else if (3 == i_0_)
				...
				anInt8124 = class536_sub33.readInt() * 1371157433;
			else if (i_0_ >= 100) {
				i_0_ -= 100;
				anIntArrayArray8107[i_0_ & (int) (Math.pow(2.0, 3.0) - 1.0)][i_0_ >> 3] = class536_sub33.readUnsignedShort();
			}
		}
	}
	...
	void method7415(RSByteBuffer class536_sub33) {
		for (;;) {
			...
			if (1 == i)
				...
				i -= 100;
				anIntArrayArray8107[i & (int) (Math.pow(2.0, 3.0) - 1.0)][i >> 3] = class536_sub33.readUnsignedShort();
			}
		}
	}
