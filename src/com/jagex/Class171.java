...
public class Class171 {
	...
	static void method2425(Class234 class234, Class251 class251, int i) {
		if (class251 != null) {
			if (-1 != -809980533 * class251.anInt2546) {
				Class251 class251_8_ = class234.method3337(-1940204141 * class251.anInt2577, 552340768);
				if (class251_8_ != null) {
					if (class251_8_.aClass251Array2725 == class251_8_.aClass251Array2726) {
						class251_8_.aClass251Array2726 = (new Class251[class251_8_.aClass251Array2725.length]);
				...
				Class251[] class251s = class234.method3338(1877345864);
				int i_10_;
	...
	static final void method2427(Class251 class251, Class234 class234, Class668 class668, int i) {
		String string = (String) (class668.anObjectArray8543[(class668.anInt8544 -= 1946079257) * 366709801]);
	...
	static final void method2429(Class251 class251, Class234 class234, Class668 class668, byte i) {
		String string = (String) (class668.anObjectArray8543[(class668.anInt8544 -= 1946079257) * 366709801]);
