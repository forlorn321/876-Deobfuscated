...
public class Class587 implements DefinitionI {
	...
	void method7066(RSByteBuffer class536_sub33, int i, byte i_1_) {
		if (i == 1)
			...
			if (65535 == 1085119891 * anInt7728)
				anInt7728 = 816379749;
			anInt7736 = class536_sub33.readUnsignedShort() * -1920174597;
			if (65535 == 437800243 * anInt7736)
				anInt7736 = 1920174597;
			int i_2_ = -1;
			if (i == 18) {
				i_2_ = class536_sub33.readUnsignedShort();
				if (i_2_ == 65535)
					i_2_ = -1;
			}
			...
			anInt7737 = class536_sub33.readUnsignedShort() * 478092401;
		else if (20 == i)
	...
	void method7072(RSByteBuffer class536_sub33, int i) {
		if (i == 1)
			...
			int i_9_ = -1;
			if (i == 18) {
				i_9_ = class536_sub33.readUnsignedShort();
				if (i_9_ == 65535)
					i_9_ = -1;
			}
	...
	void method7078(RSByteBuffer class536_sub33, int i) {
		if (i == 1)
			...
			int i_12_ = -1;
			if (i == 18) {
				i_12_ = class536_sub33.readUnsignedShort();
				if (i_12_ == 65535)
					i_12_ = -1;
			}
