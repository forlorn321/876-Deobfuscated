...
public class Class317 {
	...
	public static int method4227(int i, int i_7_, boolean bool, int i_8_) {
		...
		for (int i_10_ = 0; i_10_ < class536_sub1.anIntArray10304.length; i_10_++) {
			if (class536_sub1.anIntArray10304[i_10_] >= 0 && (((Class1) Class111.aClass34_Sub13_1391.method70((class536_sub1.anIntArray10304[i_10_]), (byte) -53)).anInt18 * -1423460053) == i_7_)
