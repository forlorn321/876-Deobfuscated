...
public class Class617 {
		...
		if (null == class177 || class167.method2308(class177.method2466(), i_11_) != 0) {
			...
			for (int i_27_ = 0; i_27_ < is_12_.length; i_27_++) {
				...
				if ((i_28_ & 0x40000000) != 0) {
					...
					if (!((Class1) class34_sub13.method70(i_28_ & 0x3fffffff, (byte) 107)).method515(aBool8076, class12, -797291593))
						bool_26_ = true;
			...
			if (bool_26_) {
				...
				for (int i_32_ = 0; i_32_ < is_12_.length; i_32_++) {
					...
					if ((i_33_ & 0x40000000) != 0) {
						...
						Class180 class180 = ((Class1) class34_sub13.method70(i_33_ & 0x3fffffff, (byte) -106)).method509(aBool8076, class12, -1431934785);
						if (class180 != null)
		...
		if (null == class177 || class167.method2308(class177.method2466(), i_51_) != 0) {
			...
			for (int i_53_ = 0; i_53_ < anIntArray8071.length; i_53_++) {
				...
				if ((i_54_ & 0x40000000) != 0) {
					...
					if (!((Class1) class34_sub13.method70(i_54_ & 0x3fffffff, (byte) -18)).method514(aBool8076, class12, 1499603302))
						bool = true;
			...
			for (int i_56_ = 0; i_56_ < anIntArray8071.length; i_56_++) {
				...
				if (0 != (i_57_ & 0x40000000)) {
					...
					Class180 class180 = ((Class1) class34_sub13.method70(i_57_ & 0x3fffffff, (byte) -5)).method517(aBool8076, class12, (byte) -79);
					if (class180 != null)
	...
	static final void method7365(Class668 class668, int i) {
		Class710.aClass536_Sub40_8843.method9857((Class710.aClass536_Sub40_8843.aClass710_Sub35_10742), (class668.anIntArray8541[((class668.anInt8542 -= -1411037171) * 1867269829)]), (byte) 1);
	...
	static final void method7369(Class668 class668, int i) {
		...
		InterfaceDefinitions class251 = Class264.method3678(i_100_, -689214737);
