...
public class Class58 implements Interface6 {
	...
	public ConfigType method55(int i, Interface12 interface12, int i_0_) {
		...
		try {
			ConfigType interface13_1_ = (ConfigType) aClass611.newInstance();
	...
	public ConfigType method54(int i, Interface12 interface12) {
		ConfigType interface13;
		try {
			ConfigType interface13_2_ = (ConfigType) aClass611.newInstance();
	...
	public ConfigType method53(int i, Interface12 interface12) {
		ConfigType interface13;
		try {
			ConfigType interface13_3_ = (ConfigType) aClass611.newInstance();
