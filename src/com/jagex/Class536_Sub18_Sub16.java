...
public class Class536_Sub18_Sub16 extends Class536_Sub18 {
		...
		if (Class499.aClass499_5566 == class499 || Class499.aClass499_6519 == class499) {
			...
			case 2:
				if (null == anObjectArray11796)
					anObjectArray11796 = new Object[i_2_];
				anObjectArray11796[i] = class536_sub33.readString().intern();
				break;
			case 3:
				if (null == anObjectArray11796)
					anObjectArray11796 = new Object[i_2_];
				class499 = Class499.aClass499_5600;
				anObjectArray11796[i] = Long.valueOf(class536_sub33.readLong());
				break;
			default:
				throw new RuntimeException();
			}
	...
	int method10788(RSByteBuffer class536_sub33, int i) {
		...
		anInt11795 = class536_sub33.readUnsignedShort() * 756272105;
		anInt11799 = class536_sub33.readUnsignedShort() * -2144602595;
		anInt11802 = class536_sub33.readUnsignedShort() * -698386297;
