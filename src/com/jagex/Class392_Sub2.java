/* Class392_Sub2 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
package com.jagex;

public class Class392_Sub2 extends Class392 {
	public int anInt10223;
	public int anInt10224;

	public Class390 method342() {
		return Class390.aClass390_4059;
	}
	...
	public static Class392 method9305(RSByteBuffer class536_sub33) {
		...
		int i = class536_sub33.method9709(-1269565476);
		int i_0_ = class536_sub33.method9709(-800359270);
	...
	Class392_Sub2(Class395 class395, Class399 class399, int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
		super(class395, class399, i, i_2_, i_3_, i_4_, i_5_, i_6_, i_7_);
		anInt10224 = i_9_ * -1506646739;
		anInt10223 = i_10_ * 612851055;
	}
	...
	public static Class392 method9306(RSByteBuffer class536_sub33) {
		...
		int i = class536_sub33.method9709(-1619728206);
		int i_11_ = class536_sub33.method9709(253653284);
