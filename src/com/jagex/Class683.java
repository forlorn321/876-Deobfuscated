...
public class Class683 {
	...
	boolean method8096(int i, int i_1_, short i_2_) {
		Class251 class251 = Class527.method6429(i, i_1_, (byte) -32);
		if (null != class251) {
			aClass234_8649 = Class463.aClass234Array5227[i >> 16];
			aClass251_8650 = class251;
			return true;
	...
	boolean method8098(int i, int i_3_) {
		Class251 class251 = Class527.method6429(i, i_3_, (byte) -47);
		if (null != class251) {
			aClass234_8649 = Class463.aClass234Array5227[i >> 16];
			aClass251_8650 = class251;
			return true;
	...
	boolean method8099(int i, int i_4_) {
		Class251 class251 = Class527.method6429(i, i_4_, (byte) -121);
		if (null != class251) {
			aClass234_8649 = Class463.aClass234Array5227[i >> 16];
			aClass251_8650 = class251;
			return true;
