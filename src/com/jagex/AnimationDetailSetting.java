/* Class710_Sub23 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
package com.jagex;

public class AnimationDetailSetting extends ClientSetting {
	public static final int anInt10878 = 1;
	public static final int anInt10879 = 0;

	public AnimationDetailSetting(int i, ClientSettings class536_sub40) {
		super(i, class536_sub40);
	}

	public void method10123() {
		if (1 != anInt8842 * -789865385 && 0 != -789865385 * anInt8842)
			anInt8842 = method8347((byte) 72) * -1100148889;
	}

	public void method10124(int i) {
		if (1 != anInt8842 * -789865385 && 0 != -789865385 * anInt8842)
			anInt8842 = method8347((byte) 63) * -1100148889;
	}
	...
	public boolean method10125(int i) {
		return true;
	}
	...
	public int method10128() {
		return -789865385 * anInt8842;
	}

	public boolean method10129() {
		return true;
	}
	...
	public int method10130() {
		return -789865385 * anInt8842;
	}

	public AnimationDetailSetting(ClientSettings class536_sub40) {
		super(class536_sub40);
	}

	public int method10131() {
		return -789865385 * anInt8842;
	}

	static final void method10132(int i) {
		Class598 class598 = client.aClass515_11066.method6255(-2125595752);
