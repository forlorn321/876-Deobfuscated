...
public class Class400 {
	...
	void method4915(RSByteBuffer class536_sub33, int i, int i_1_, byte i_2_) {
		if (i == 1) {
			...
			anInt4133 = class536_sub33.readUnsignedByte() * 877307167;
		else if (5 == i)
			anInt4135 = class536_sub33.readUnsignedByte() * 1821475021;
		else if (i == 6)
			aBool4134 = true;
		else if (i == 7)
			aBool4136 = true;
	...
	static final void method4918(IComponentDefinitions class251, Class234 class234, Class668 class668, int i) {
