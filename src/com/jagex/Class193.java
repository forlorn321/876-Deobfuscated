...
public class Class193 {
	...
	public static void method2848(boolean bool) {
		if (client.anInt11074 * 1542697723 != 2 && 3 != 1542697723 * client.anInt11074) {
			...
			OutgoingPacketContainer class536_sub23 = Class213.createOutgoingPacket(OutgoingPacket.aClass414_4425, client.aClass106_11322.aClass15_1258, 1954661498);
			class536_sub23.stream.writeByte(bool ? 1 : 0);
			client.aClass106_11322.writePacket(class536_sub23, 925036261);
		}
	}
	...
	public static void method2849(boolean bool) {
		if (client.anInt11074 * 1542697723 != 2 && 3 != 1542697723 * client.anInt11074) {
			...
			OutgoingPacketContainer class536_sub23 = Class213.createOutgoingPacket(OutgoingPacket.aClass414_4425, client.aClass106_11322.aClass15_1258, 1558865093);
			class536_sub23.stream.writeByte(bool ? 1 : 0);
			client.aClass106_11322.writePacket(class536_sub23, 1209277432);
		}
	}
	...
	static final void method2850(Class668 class668, short i) {
		...
		IComponentDefinitions class251 = Class264.getIComponentDefinitions(i_15_);
		int i_16_ = -1;
		int i_17_ = -1;
