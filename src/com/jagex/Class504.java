...
public abstract class Class504 {
	...
	static void method6079(Class251 class251, Class161 class161, int i, int i_3_, int i_4_, int i_5_, int i_6_, String string, Class184 class184, Class2 class2, int i_7_, int i_8_) {
		int i_9_;
