/* Class710_Sub39 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
package com.jagex;

public class Class710_Sub39 extends ClientSetting {
	public static final int anInt10919 = 3;
	public static final int anInt10920 = 1;
	public static final int anInt10921 = 4;
	public static final int anInt10922 = 0;
	static final int anInt10923 = 2;
	public static final int anInt10924 = 5;

	int method8355(int i) {
		return 1;
	}

	public Class710_Sub39(int i, ClientSettings class536_sub40) {
	...
	public int method10236(int i) {
		return anInt8842 * -789865385;
	}

	public void method10237(int i) {
		if (-789865385 * anInt8842 < 0 || -789865385 * anInt8842 > 5 || -789865385 * anInt8842 == 2)
			anInt8842 = method8347((byte) -92) * -1100148889;
	}
	...
	public Class710_Sub39(ClientSettings class536_sub40) {
		super(class536_sub40);
	}

	public int method10240() {
		return anInt8842 * -789865385;
	}

	public int method10241() {
		return anInt8842 * -789865385;
	}

	public int method10242() {
		return anInt8842 * -789865385;
	}
