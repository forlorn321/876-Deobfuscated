...
public class Class709 implements Interface75 {
	...
	static void method8345(Class251 class251, int i) {
		if (client.aBool11188) {
			if (null != class251.anObjectArray2624) {
				Class251 class251_3_ = Class527.method6429(1625551467 * Class663.anInt8515, -1059472497 * client.anInt11183, (byte) -93);
				if (null != class251_3_) {
