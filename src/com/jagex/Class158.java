...
public class Class158 {
	...
	public static void method1889(RSByteBuffer class536_sub33, int i, short i_1_) {
		...
		class536_sub34.anInt10621 = class536_sub33.method9709(265685866) * -251386325;
		...
		for (int i_2_ = 0; i_2_ < class536_sub34.anInt10619 * 1706012977; i_2_++) {
			try {
				...
				if (0 == i_3_ || 1 == i_3_ || i_3_ == 2) {
					String string = class536_sub33.method9695((byte) 95);
					String string_4_ = class536_sub33.method9695((byte) 120);
					int i_5_ = 0;
					if (1 == i_3_)
						i_5_ = class536_sub33.method9709(-1315305648);
					...
					String string = class536_sub33.method9695((byte) 105);
					String string_6_ = class536_sub33.method9695((byte) 87);
					int i_7_ = class536_sub33.readUnsignedByte(-61835438);
					String[] strings = new String[i_7_];
					for (int i_8_ = 0; i_8_ < i_7_; i_8_++)
						strings[i_8_] = class536_sub33.method9695((byte) 36);
					String string_9_ = class536_sub33.method9695((byte) 126);
					byte[][] is = new byte[i_7_][];
					if (i_3_ == 3) {
						for (int i_10_ = 0; i_10_ < i_7_; i_10_++) {
							int i_11_ = class536_sub33.method9709(-1807773547);
