...
public class Class574 implements DefinitionI, Interface7 {
	...
	void method6943(RSByteBuffer class536_sub33, int i) {
		if (1 == i)
			...
			anIntArray7642 = new int[class536_sub33.readUnsignedByte()];
			for (int i_0_ = 0; i_0_ < anIntArray7642.length; i_0_++)
				anIntArray7642[i_0_] = class536_sub33.readUnsignedShort();
		} else if (3 == i)
			anInt7640 = class536_sub33.readUnsignedByte() * 2117524411;
		else if (4 == i)
	...
	static final void method6946(Class668 class668, int i) {
		...
		class668.anIntArray8541[(class668.anInt8542 += -1411037171) * 1867269829 - 1] = client.method10389(class251).method9474();
	}
