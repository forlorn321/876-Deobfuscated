		...
		if (Class70.anInt760 * 1780207751 < 409) {
			if (Class565.MY_PLAYER == class649_sub1_sub5_sub1_sub2) {
				...
				if (class649_sub1_sub5_sub1_sub2.anInt12189 * -1543258759 == 0) {
					...
					if (1370751447 * (Class565.MY_PLAYER.anInt12188) != -1 && -1 != (class649_sub1_sub5_sub1_sub2.anInt12188 * 1370751447)) {
						int i_2_ = (((Class565.MY_PLAYER.anInt12188) * 1370751447 < (1370751447 * class649_sub1_sub5_sub1_sub2.anInt12188)) ? (1370751447 * (Class565.MY_PLAYER.anInt12188)) : (class649_sub1_sub5_sub1_sub2.anInt12188 * 1370751447));
						int i_3_ = ((Class565.MY_PLAYER.anInt12186) * 611144047 - (611144047 * class649_sub1_sub5_sub1_sub2.anInt12186));
						if (i_3_ < 0)
							i_3_ = -i_3_;
						if (i_3_ > i_2_)
							bool_1_ = false;
						...
						if (client.aStringArray11100[i_7_] != null) {
							...
							if ((client.aClass670_11043 == GameMode.aClass670_8568) && (client.aStringArray11100[i_7_].equalsIgnoreCase(Class38.aClass38_344.method840(Class459.CLIENT_PARAMS, 1907592279)))) {
								if (Class634.aClass634_8263 == client.aClass634_11165)
									i_8_ = (short) 2000;
								else if ((Class634.aClass634_8264 == client.aClass634_11165) && ((611144047 * (class649_sub1_sub5_sub1_sub2.anInt12186)) > (Class565.MY_PLAYER.anInt12186) * 611144047))
									i_8_ = (short) 2000;
								if ((1717228615 * (Class565.MY_PLAYER.anInt12191)) != 0 && 0 != (class649_sub1_sub5_sub1_sub2.anInt12191) * 1717228615) {
									if ((Class565.MY_PLAYER.anInt12191) * 1717228615 == (1717228615 * (class649_sub1_sub5_sub1_sub2.anInt12191)))
										i_8_ = (short) 2000;
									else
										i_8_ = (short) 0;
